...
export const initialRegistrations = [
  { id: 'r1', webinarId: 'w1', userName: 'Maya Singh', email: 'maya@example.com' },
  { id: 'r2', webinarId: 'w2', userName: 'Arjun Rao', email: 'arjun@example.com' },
  { id: 'r3', webinarId: 'w1', userName: 'Noah Smith', email: 'noah@example.com' },
]
